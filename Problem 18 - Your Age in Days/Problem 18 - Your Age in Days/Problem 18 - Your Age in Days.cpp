/**
 * @brief Program to calculate a person's age in days.
 *
 * The program:
 * 1. Reads the user's birth date.
 * 2. Retrieves the current system date.
 * 3. Calculates the age in days (optionally including today).
 *
 * Example:
 * Input:  Birth Date = 01/01/2000, Current Date = 04/01/2000
 * Output: Age = 4 days
 */
...
int main()
{
    ...
    cout << "\nYour Age is : " << GetDifferenceInDays(DateOfBirth, Date2, true) <<  " Days(s)" << endl;
